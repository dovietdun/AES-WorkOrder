(function () {
    'use strict';
    angular.module('VF.FBOmApp.UIProcessStatus').config(ViewScreenStateConfig);

    ViewScreenController.$inject = ['VF.FBOmApp.UIProcessStatus.UIProcessStatusScreen.service', '$state', '$stateParams', 'common.base', '$filter', '$scope'];
        ...
        var state = {
            ...
            views: {
                'property-area-container@': {
                    templateUrl: moduleFolder + '/UIProcessStatusScreen-select.html',
