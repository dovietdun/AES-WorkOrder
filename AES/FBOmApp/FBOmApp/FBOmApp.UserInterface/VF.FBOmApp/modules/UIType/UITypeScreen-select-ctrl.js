(function () {
    'use strict';
    angular.module('VF.FBOmApp.UIType').config(ViewScreenStateConfig);

    ViewScreenController.$inject = ['VF.FBOmApp.UIType.UITypeScreen.service', '$state', '$stateParams', 'common.base', '$filter', '$scope'];
    ...
    function ViewScreenStateConfig($stateProvider) {
        var screenStateName = 'home.VF_FBOmApp_UIType_UITypeScreen';
        ...
        var state = {
            ...
            views: {
                'property-area-container@': {
                    templateUrl: moduleFolder + '/UITypeScreen-select.html',
