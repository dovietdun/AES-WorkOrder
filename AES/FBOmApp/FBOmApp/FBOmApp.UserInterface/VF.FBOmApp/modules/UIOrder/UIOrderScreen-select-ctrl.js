(function () {
    'use strict';
    angular.module('VF.FBOmApp.UIOrder').config(ViewScreenStateConfig);

    ViewScreenController.$inject = ['VF.FBOmApp.UIOrder.UIOrderScreen.service', '$state', '$stateParams', 'common.base', '$filter', '$scope'];
        ...
        var state = {
            ...
            views: {
                'property-area-container@': {
                    templateUrl: moduleFolder + '/UIOrderScreen-select.html',
