(function () {
    'use strict';
    angular.module('VF.FBOmApp.UIMaterial').config(AddScreenStateConfig);

    AddScreenController.$inject = ['VF.FBOmApp.UIMaterial.UIMaterialScreen.service', '$state', '$stateParams', 'common.base', '$filter', '$scope'];
        ...
        var state = {
            ...
            views: {
                'property-area-container@': {
                    templateUrl: moduleFolder + '/UIMaterialScreen-add.html',
