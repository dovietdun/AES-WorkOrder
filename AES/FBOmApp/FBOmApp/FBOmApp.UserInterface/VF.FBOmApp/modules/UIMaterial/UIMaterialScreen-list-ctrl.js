(function () {
    'use strict';
    angular.module('VF.FBOmApp.UIMaterial').config(ListScreenRouteConfig);

    ListScreenController.$inject = ['VF.FBOmApp.UIMaterial.UIMaterialScreen.service', '$state', '$stateParams', '$rootScope', '$scope', 'common.base', 'common.services.logger.service'];
    function ListScreenController(dataService, $state, $stateParams, $rootScope, $scope, base, loggerService) {
        ...
        function activate() {
            logger = loggerService.getModuleLogger('VF.FBOmApp.UIMaterial.UIMaterialScreen');
        ...
        function init() {
            ...
            rootstate = 'home.VF_FBOmApp_UIMaterial_UIMaterialScreen';
    ...
    function ListScreenRouteConfig($stateProvider) {
        ...
        var state = {
            name: moduleStateName + '_UIMaterialScreen',
            url: '/' + moduleStateUrl + '_UIMaterialScreen',
            views: {
                'Canvas@': {
                    templateUrl: moduleFolder + '/UIMaterialScreen-list.html',
                    controller: ListScreenController,
                    controllerAs: 'vm'
                }
            },
            data: {
                title: 'UIMaterialScreen'
            }
        };
