(function () {
    'use strict';
    angular.module('VF.FBOmApp.UIStatus').config(ViewScreenStateConfig);

    ViewScreenController.$inject = ['VF.FBOmApp.UIStatus.UIStatusScreen.service', '$state', '$stateParams', 'common.base', '$filter', '$scope'];
        ...
        var state = {
            ...
            views: {
                'property-area-container@': {
                    templateUrl: moduleFolder + '/UIStatusScreen-select.html',
