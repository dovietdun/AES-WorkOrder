(function () {
    'use strict';
    angular.module('VF.FBOmApp.UIStatus')
        .constant('VF.FBOmApp.UIStatus.UIStatusScreen.constants', ScreenServiceConstants())
        .service('VF.FBOmApp.UIStatus.UIStatusScreen.service', ScreenService)
    ...
    function ScreenServiceConstants() {
        return {
            data: {
                ...
                entityName: 'StatusDef',
                createPublicName: null,
                updatePublicName: null,
                deletePublicName: null,
                cmdStatus: 'StatusDefCmd'
            }
        };
    }

    ScreenService.$inject = ['$q', '$state', 'common.base', 'VF.FBOmApp.UIStatus.UIStatusScreen.constants', 'common.services.logger.service'];
    function ScreenService($q, $state, base, context, loggerService) {
        ...
        activate();
        function activate() {
            logger = loggerService.getModuleLogger('VF.FBOmApp.UIStatus.UIStatusScreen.service');
        ...
        function createEntity(data) {
            ...
            return execCommand(context.data.cmdStatus, obj);
        }
    ...
    ScreenServiceRun.$inject = ['VF.FBOmApp.UIStatus.UIStatusScreen.constants', 'common.base'];
