...
/* Version 1.5.3, copyright (C) 2019, Siemens AG. All Rights Reserved. */
   ...
   */
	 ...
	 */
	  _beginPosition = function (left, top, width, height) {
	    ...
	    _settings.left = left;
	    _iframe.style.left = _settings.left;

	    _settings.top = top;
	    _iframe.style.top = _settings.top;

	    _settings.width = width;
	    _iframe.style.width = _settings.width;

	    _settings.height = height;
	    _iframe.style.height = _settings.height;
 ...
 */
  var _beginCreateIFrame = function (arg) {
    ...
    onLoadErrorCallback = function (e) {
      var target = e.target ? e.target : e.srcElement;
      ...
      SWAC.Logging.log('Error in onLoadErrorCallback for ' + target.name + '.', SWAC.Logging.Level.Internal);
    };
