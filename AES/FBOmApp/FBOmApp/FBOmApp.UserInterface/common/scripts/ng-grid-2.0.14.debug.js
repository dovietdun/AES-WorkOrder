...
(function (window, $) {
    ...
    var ngRowFactory = function (grid, $scope, domUtilityService, $templateCache, $utils) {
        ...
        self.renderedChange = function () {
            ...
            //START - Remove the code when advanced lazy loadind implemented
            /** Lazy loading for group by
             *  This is a temporary code. 
             *  Remove the code when lazy loading implemented for complete ng-grid
             *  set the _limit to 50 which instruct to load 50 data from _begin index
             * */
            var ROW_HEIGHT = 31;
            var DEFAULT_DATA_LOAD_LIMIT = 50;
            var recordsPerHeight = grid.rootDim.outerHeight / ROW_HEIGHT || 0;
            $scope._limit = recordsPerHeight > DEFAULT_DATA_LOAD_LIMIT ? recordsPerHeight : DEFAULT_DATA_LOAD_LIMIT;
            var scrollValue = grid.$viewport.scrollTop();
            var begin = (scrollValue / ROW_HEIGHT);
            if (begin < 0) begin = 0;
            $scope._begin = begin;
            //END
    ...
    angular.module('ngGrid').run(['$templateCache', function ($templateCache) {
        ...
        $templateCache.put('aggregateTemplate.html',
            ...
            " <label>" +
            " <input type=\"checkbox\" style=\"margin: 0 10px 0 2px; cursor: pointer\" ng-click=\"selectAggregate(row.getAggregateSelectArg(true));\" ng-checked=\"row.getCheckState();\"/>" +
        ...
        $templateCache.put('checkboxHeaderTemplate.html',
            ...
            "<div class=\"check-box checkbox-enabled\" style=\"padding-top:2px;display:block; position:static\">" +
            "<label>" +
            "<input class=\"ngSelectionHeader\" type=\"checkbox\" ng-show=\"multiSelect\" style=\" top:2px\"" +
        ...
        $templateCache.put('checkboxCellTemplate.html',
            ...
            "<div class=\"check-box checkbox-enabled\" style=\"padding-top:2px;display:block; position:static\">" +
            "<label>" +
            " <input type=\"checkbox\" data-checked=\"{{row.selected}}\" ng-model=\"row.selected\">" +
            "<span class=\"property-label-ellipsis\">" +
            "<span class=\"check\"></span></span>" +
            "</label>" +
            "</div>" +
        ...
        $templateCache.put('headerCellTemplate.html',
            // © Siemens AG, 2014
            "<div class=\"ngHeaderSortColumn {{col.headerClass}}\" ng-style=\"{'cursor': col.cursor}\" ng-class=\"{ 'ngSorted': !col.noSortVisible() }\" ng-click=\"col.sort($event)\">\r" +
            "\n" +
            "    <div id=\"header-sort-button\" ng-attr-title=\"{{col.displayName}}\" ng-class=\"'colt' + col.index\" class=\"ngHeaderText\">{{col.displayName}}</div>\r" +
            "\n" +
            ...
            "</div >\r" +
            "\n" +
            "    <div class=\"ngSortButtonUp\" ng-show=\"col.showSortButtonUp()\">\r" +
            "\n" +
            ...
            "</div>\r" +
            "\n" +
            "<div id=\"header-resize-button\" ng-show=\"col.resizable\" class=\"ngHeaderGrip\" ng-click=\"col.gripClick($event)\" ng-mousedown=\"col.gripOnMouseDown($event)\"><span></span></div>\r" +
            "\n"
        );
