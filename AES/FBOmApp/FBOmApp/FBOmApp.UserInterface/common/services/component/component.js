...
(function () {
    ...
    SwacComponentService.$inject = ['common.services.component.swacContainerService', '$timeout', 'common.services.logger.service', '$rootScope', '$q', '$location', 'common.services.umc'];
    function SwacComponentService(swacContainerService, $timeout, logger, $rootScope, $q, $location, umcService) {
        var vm = this;
        var components = {};
        ...
        function init() {
            ...
            vm.setContainerEnvironment = setContainerEnvironment;
        }
