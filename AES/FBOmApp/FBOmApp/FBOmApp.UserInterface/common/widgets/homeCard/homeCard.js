...
(function () {
    ...
    angular
        ...
        .component('sitHomeCard', {
            ...
            controller: function () {
                    var MAX_DESC_CHAR = 90;
                    this.visibleDescription = this.options.description;
                    if(this.options.description.length > MAX_DESC_CHAR){
                       this.visibleDescription = this.options.description.substring(0, MAX_DESC_CHAR) + "..." ;
                    }
            },
