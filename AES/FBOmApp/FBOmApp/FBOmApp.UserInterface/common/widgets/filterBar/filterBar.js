...
*/
    ...
    function FilterBarController($scope, $translate, $rootScope, common, LOG_TYPES, securityService, functionRightModel, tagsManagementService) {
        ...
        function init() {
            ...
            vm.isPrintEnabled = vm.filterOptions.printOptions && vm.filterOptions.printOptions.enabled ? true : false;
            vm.printTooltip = vm.isPrintEnabled && vm.filterOptions.printOptions.tooltip ? vm.filterOptions.printOptions.tooltip : $translate.instant('filterBar.print');
        ...
        function onPrintClicked() {
            if (!vm.filterOptions.printOptions.onClick) {
                return;
            }
            vm.filterOptions.printOptions.onClick();
        }
            ...
            vm.commandBarData =
                {
                    ...
                    "bar": [
                        ...
                        },
                        {
                            "label": "",
                            "name": "Print",
                            "tooltip": $translate.instant(vm.printTooltip),
                            "svgIcon": "common/icons/cmdPrint24.svg",
                            "type": "Command",
                            "visibility": vm.isPrintEnabled,
                            'onClickCallback': onPrintClicked
                        }
                    ]
                };
