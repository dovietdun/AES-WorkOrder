    ...
    angular.module('siemens.simaticit.common.services.modelDriven')
        ...
        .controller(ctrl, ['$state', '$rootScope', '$translate', 'common.base', '$q', '$timeout', 'common.services.modelDriven.service',
            ...
            'common.services.swac.SwacUiModuleManager', function ($state, $rootScope, $translate, base, $q, $timeout, md, mdrt, $stateParams,
                ...
                mdContextSrv.alignSessionStorage(stateId);
                md.loadModule(stateId).then(function (manifest) {
                    ...
                    function setBreadCrumbforMasterSelection() {
                        ...
                        if (masterInfo) {
                            ...
                            breadCrumbChain = self.mdViewCtrl.getBreadcrumbChain();
                    ...
                    if (self.mdViewCtrl[masterName]) {
                        ...
                        self.mdViewCtrl[masterName].onOpenClick = function (item, destScreen, drillDownParams) {
                            ...
                            if (item && item.Id) {
                                ...
                                var breadcrumbField = getBreadcrumbField(destScreenId);
                                var destScreenMasterInfo = getContentInfo(item, breadcrumbField, drillDownParams, prop);
